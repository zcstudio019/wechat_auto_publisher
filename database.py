...
def init_default_templates(conn=None):
    ...
    templates = [
        ...
        {
            "name": "贷款行业底层规律型文章", "category": "industry_law", "category_label": "贷款行业底层规律",
            "description": "从银行逻辑、偿债能力和产品匹配解释贷款行业的底层规律?",
            "structure": ["反常识结论", "老板常见误区", "银行真实逻辑", "典型经营场景", "3-5条底层规律", "行动建议", "结尾总结", "融资体检CTA"],
            "pain_point": "企业主只看到资金缺口，未理解银行如何判断还款能力和风险?",
            "hook": "先做企业融资体检，梳理融资条件和申请顺序?",
            "prompt_template": "请以「{topic}」为主题，写贷款行业底层规律型文章：反常识开头、误区、银行真实逻辑、典型场景、3-5条规律、行动建议、总结和融资体检CTA；不承诺放款，不输出二维码代码?",
        },
    ]
